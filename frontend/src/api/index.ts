...
export const api = {
  ...
  checkRates: (homeId: string, sourceUrl?: string) => apiRequest(homePath('/rate-sources/check-now', homeId), rateCheckResultSchema, { method: 'POST', body: jsonBody(sourceUrl ? { source_url: sourceUrl } : {}) }),
