...
export const billingSchema = z.object({
  accounts: z.array(z.object({
    ...
    current_billing_cycle: z.object({
      ...
      readings_waiting_to_sync: z.number().int().nonnegative().nullable(),
...
export const systemHealthSchema = z.object({
  ...
  sensors: z.array(z.object({
    ...
    pzem_status: z.string(), storage_status: z.string(), backlog: z.number().nullable(), firmware_version: z.string().nullable().optional(),
