...
export const telemetrySettingsSchema = z.object({
  ...
  telemetry_interval_seconds: z.union([z.literal(2), z.literal(5), z.literal(10), z.literal(15), z.literal(30), z.literal(60)]),
  history_interval_seconds: z.union([z.literal(15), z.literal(30), z.literal(60), z.literal(300), z.literal(900)]),
  retention_days: z.union([z.literal(30), z.literal(90), z.literal(180), z.literal(365)]).nullable(),
...
export const deviceSummarySchema = z.object({
  ...
  storage_status: z.string().nullable().optional(),
  telemetry_protocol: z.string().nullable().optional(),
  server_delivery_status: z.string().nullable().optional(),
  last_server_received_at: isoDate.nullable().optional(),
  last_sensor_sampled_at: isoDate.nullable().optional(),
  sensor_time_trusted: z.boolean().nullable().optional(),
  cumulative_energy_kwh: nullableTelemetryNumber.optional(),
...
export const homeSchema = z.object({
  ...
  aggregate_measurement: z.object({
    state: z.enum(['live', 'partial', 'unavailable']),
    active_power_w: nullableTelemetryNumber,
    ...
    available_member_count: z.number().int().nonnegative().optional(),
    required_member_count: z.number().int().nonnegative().optional(),
    missing_member_device_ids: z.array(z.string()).default([]),
  }).nullable().optional(),
...
export const historySchema = z.object({
  ...
  connection_gaps: z.array(z.object({
    event_id: z.string().optional(),
    device_id: z.string(),
    start_utc: isoDate,
    end_utc: isoDate,
    recovered_energy_kwh: nullableDecimal,
    status: z.enum(['recovered', 'unresolved']),
    crosses_billing_cycle: z.boolean(),
  }).passthrough()).default([]),
  recovered_gap_energy_kwh: nullableDecimal.optional(),
...
export const billingSchema = z.object({
  accounts: z.array(z.object({
    ...
    fixed_charges_included: z.boolean(),
    cca_or_direct_access: z.string().nullable(),
    home_total_branch: z.object({
      id: z.string(),
      name: z.string(),
      device_ids: z.array(z.string()).default([]),
    }).passthrough().nullable().optional(),
    current_billing_cycle: z.object({
      start_utc: isoDate,
      end_utc: isoDate,
      service_branch_id: z.string().nullable(),
      service_branch_name: z.string().nullable(),
      saved_usage_kwh: nullableDecimal,
      current_usage_kwh: nullableDecimal.optional(),
      reading_coverage: nullableDecimal,
      readings_waiting_to_sync: z.number().int().nonnegative().nullable().optional(),
      tier_state: z.enum(['tier_1', 'tier_2', 'estimated_tier_1', 'estimated_tier_2', 'not_confirmed']),
      tier_confirmation_rule: z.string(),
      tier_1_allowance_kwh: nullableDecimal,
      tier_1_remaining_kwh: nullableDecimal,
      amount_above_tier_1_kwh: nullableDecimal,
      estimated_energy_charges: nullableDecimal,
      estimated_fixed_charges: nullableDecimal,
      estimated_total: nullableDecimal,
      connection_gap_energy_kwh: nullableDecimal.optional(),
      recovered_gap_energy_kwh: nullableDecimal.optional(),
      measured_energy_kwh: nullableDecimal.optional(),
      estimated_missing_energy_kwh: nullableDecimal.optional(),
      estimated_missing_energy_lower_kwh: nullableDecimal.optional(),
      estimated_missing_energy_upper_kwh: nullableDecimal.optional(),
      unknown_energy_kwh: nullableDecimal.optional(),
      unknown_gap_seconds: z.number().int().nonnegative().optional(),
      billing_adjustment_kwh: nullableDecimal.optional(),
      unresolved_connection_gap_count: z.number().int().nonnegative().optional(),
      unresolved_energy_kwh: nullableDecimal.optional(),
      tier_1_usage_kwh: nullableDecimal.optional(),
      tier_2_usage_kwh: nullableDecimal.optional(),
      tier_1_rate_per_kwh: nullableDecimal.optional(),
      tier_2_rate_per_kwh: nullableDecimal.optional(),
      tier_1_cost: nullableDecimal.optional(),
      tier_2_cost: nullableDecimal.optional(),
      service_charge: nullableDecimal.optional(),
      cost_to_date: nullableDecimal.optional(),
      tier_breakdown: z.object({
        tier_1: z.object({
          usage_kwh: decimal,
          allowance_kwh: decimal,
        ...
        tier_2: z.object({
          usage_kwh: decimal,
          starts_above_kwh: decimal,
          rate_per_kwh: decimal,
          cost: decimal,
        }).strict(),
        service_charge_to_date: nullableDecimal,
        total_to_date: nullableDecimal,
        calculation_basis: z.enum(['exact', 'estimated']).optional(),
        cost_range: z.object({ lower: decimal, upper: decimal }).strict().nullable().optional(),
      }).strict().nullable().optional(),
      projection: z.object({
        status: z.enum(['available', 'insufficient_data', 'not_enough_data', 'ready']),
        projected_usage_kwh: nullableDecimal.optional(),
        projected_tier_1_usage_kwh: nullableDecimal.optional(),
        projected_tier_2_usage_kwh: nullableDecimal.optional(),
        projected_tier_1_cost: nullableDecimal.optional(),
        projected_tier_2_cost: nullableDecimal.optional(),
        projected_energy_charges: nullableDecimal.optional(),
        projected_service_charge: nullableDecimal.optional(),
        projected_total: nullableDecimal.optional(),
        confidence: z.enum(['high', 'moderate', 'limited', 'insufficient']).nullable().optional(),
        confidence_reasons: z.array(z.string()).default([]),
      }).passthrough().nullable().optional(),
      energy_quality: z.object({
        measured_kwh: decimal,
        recovered_kwh: decimal,
        estimated_kwh: decimal,
        unknown_kwh: nullableDecimal,
        unknown_gap_count: z.number().int().nonnegative(),
        unknown_gap_seconds: z.number().int().nonnegative(),
        estimation_methods: z.array(z.string()),
        estimate_details: z.array(z.record(z.string(), z.unknown())).default([]),
        raw_history_modified: z.literal(false),
      }).passthrough().optional(),
      calculation_state: z.enum(['exact', 'estimated', 'partial', 'unavailable']).optional(),
      confidence: z.enum(['high', 'moderate', 'limited', 'insufficient']).nullable().optional(),
      confidence_reasons: z.array(z.string()).default([]),
      availability_reasons: z.array(z.object({
        code: z.string(),
        message: z.string(),
        severity: z.enum(['info', 'warning', 'error']),
      }).strict()).default([]),
      cost_range: z.object({ lower: decimal, upper: decimal }).strict().nullable().optional(),
      cost_basis: z.enum(['cycle_total', 'measured_periods_exact_gap_energy_unallocated']).optional(),
      tou_unallocated_gap_energy_kwh: nullableDecimal.optional(),
    }).passthrough().nullable().optional(),
    current_rate_plan: z.object({
      rate_plan_id: z.string(),
      rate_plan_version_id: z.string(),
      name: z.string(),
      utility_name: z.string(),
      rate_class: z.string(),
      effective_start: rateEffectiveDate,
      currently_used: z.boolean(),
      tier_1_price_per_kwh: nullableDecimal,
      tier_2_price_per_kwh: nullableDecimal,
      daily_service_charge: nullableDecimal,
      daily_baseline_allowance_kwh: nullableDecimal,
      generation_service: z.string().nullable(),
    }).passthrough().nullable().optional(),
...
export const sceRateCatalogSchema = z.object({
  ...
  plans: z.array(z.object({
    ...
    rate_precision: z.string().default('unverified'),
    exact_rates_verified: z.boolean().default(false),
    rate_component_scope: z.union([z.string(), z.array(z.unknown()), z.record(z.string(), z.unknown())]).nullable().optional(),
    baseline_credit_scope: z.string().nullable().optional(),
...
export const deviceDetailSchema = z.object({
  ...
  firmware_build_id: z.union([z.string(), z.number()]).nullable().optional(),
  firmware_digest: z.string().nullable().optional(),
  boot_partition: z.string().nullable().optional(),
  last_successful_ota: z.string().nullable().optional(),
  protocol: z.string(),
  ...
  storage_status: z.string().nullable().optional(),
  storage_bytes_total: z.number().int().positive().nullable().optional(),
  ...
  synchronization: z.object({
    ...
    last_sensor_sampled_at: isoDate.nullable().optional(),
    sensor_time_trusted: z.boolean().nullable().optional(),
    last_batch_start: z.number().int().nonnegative().nullable().optional(),
    last_batch_end: z.number().int().nonnegative().nullable().optional(),
    selected_record_count: z.number().int().nonnegative().nullable().optional(),
    serialized_bytes: z.number().int().nonnegative().nullable().optional(),
    http_result: z.union([z.string(), z.number()]).nullable().optional(),
    last_accepted_sequence: z.number().int().nonnegative().nullable().optional(),
    missing_prefix_status: z.string().nullable().optional(),
    last_error: z.string().nullable().optional(),
    queue_drain_rate: nullableDecimal.optional(),
  }).passthrough().nullable().optional(),
...
export const homeUtilitySchema = z.object({
  ...
  utility: z.object({
    ...
    generation_service_kind: z.enum(['sce_generation', 'cca', 'direct_access', 'unknown']).default('unknown'),
    baseline_region: z.string().nullable().default(null),
    summer_baseline_kwh_per_day: nullableDecimal.default(null),
    winter_baseline_kwh_per_day: nullableDecimal.default(null),
    all_electric: z.boolean().default(false),
    medical_baseline: z.boolean().default(false),
    heat_pump_allocation: z.boolean().default(false),
    estimate_high_coverage: decimal.default('0.99'),
    estimate_min_coverage: decimal.default('0.95'),
    max_estimatable_gap_seconds: z.number().int().positive().default(900),
    billing_history_interval_seconds: z.union([z.literal(15), z.literal(30), z.literal(60), z.literal(300), z.literal(900)]).default(60),
    projection_minimum_hours: z.number().int().positive().default(24),
  }).passthrough(),
  billing_evidence_retention_policy: z.literal('indefinite_immutable_evidence').default('indefinite_immutable_evidence'),
  billing_configuration_owner: z.literal('settings_rates_and_data_sources').optional(),
  billing_configuration_writable: z.boolean().optional(),
  usage_source: z.string(),
}).passthrough();
...
export const circuitSchema = z.object({
  ...
  name: z.string(),
  description: z.string().nullable().optional(),
  purpose: z.enum(['electrical_section', 'whole_home_total']).optional(),
  is_home_total: z.boolean().optional(),
  aggregate_mode: z.string(),
  non_overlapping_confirmed: z.boolean().optional(),
  is_billing_source: z.boolean().optional(),
  device_ids: z.array(z.string()).default([]),
  created_at: isoDate.optional(),
  updated_at: isoDate.optional(),
}).passthrough();
...
export const systemHealthSchema = z.object({
  ...
  database: z.string(),
  frontend: z.object({
    version: z.string().optional(), commit: z.string().optional(), build_time: isoDate.optional(),
    image_name: z.string().optional(), image_digest: z.string().optional(), static_asset_build_id: z.string().optional(), cache_version: z.string().optional(),
  }).passthrough().optional(),
  backend: z.object({
    version: z.string().optional(), commit: z.string().optional(), build_time: isoDate.optional(), api_version: z.string().optional(),
    image_name: z.string().optional(), image_digest: z.string().optional(), protocol: z.string().optional(),
  }).passthrough().optional(),
  database_migration: z.object({ current: z.string().optional(), expected: z.string().optional(), compatible: z.boolean().optional() }).passthrough().optional(),
  compatibility: z.object({ compatible: z.boolean().optional(), message: z.string().optional() }).passthrough().optional(),
  sensors: z.array(z.object({
    device_id: z.string(), device_name: z.string().optional(), state: z.string(), heartbeat_age_seconds: nullableNumber,
    pzem_status: z.string(), storage_status: z.string().nullable().optional(), backlog: z.number().nullable().optional(), firmware_version: z.string().nullable().optional(),
    ...
    latest_stored_history_interval_at: isoDate.nullable().optional(), recent_accepted_sample_count: z.number().int().nonnegative().optional(),
    recent_acceptance_window_seconds: z.number().int().positive().optional(),
    ...
    synchronization: z.object({
      server_delivery_status: z.string().nullable().optional(), last_server_received_at: isoDate.nullable().optional(),
      last_sensor_sampled_at: isoDate.nullable().optional(), sensor_time_trusted: z.boolean().nullable().optional(),
      last_batch_start: z.number().int().nonnegative().nullable().optional(), last_batch_end: z.number().int().nonnegative().nullable().optional(),
      selected_record_count: z.number().int().nonnegative().nullable().optional(), serialized_bytes: z.number().int().nonnegative().nullable().optional(),
      http_result: z.union([z.string(), z.number()]).nullable().optional(), last_accepted_sequence: z.number().int().nonnegative().nullable().optional(),
      missing_prefix_status: z.string().nullable().optional(), last_error: z.string().nullable().optional(), queue_drain_rate: nullableDecimal.optional(),
    }).passthrough().nullable().optional(),
  }).passthrough()),
