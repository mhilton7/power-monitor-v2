...
export function HomePage() {
  ...
  const beginPowerBrushInteraction = (event: { target: EventTarget | null }) => {
  ...
  const finishPowerBrushKeyboardInteraction = () => { powerBrushKeyboardInputRef.current = false; };
