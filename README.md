...
provisioning. Coordinated rc.8 is pending with bounded OTA command delivery,
browser telemetry normalization, and strict bill-extraction home validation;
it is not an installation artifact until its signed tagged workflow publishes
the complete matching asset set after firmware rc.8 is public and verified.
