...
| 14 | OTA metadata/download/manifest/queue/rollback implementation and local release pack | historical rc.1 build/contract evidence and signed public firmware through rc.6 exist; marked-unit OTA rollback remains pending |
...
| 16 | immutable PZEM ingestion/cost lineage, bill separation, and frozen explicit migrations through current `20260815_0012` | post-rc.3 source added 0008 fail-closed raw/permanent-loss overlap guards and 0010 permanent-loss UPDATE/DELETE immutability without rewriting evidence; public rc.5 reached `20260815_0011`; rc.6 added 0012 settings/rate-evidence fields without rewriting existing identities or evidence; rc.8 adds no migration and rollback remains separate |
...
| 27 | server/frontend/deployment/firmware gates and evidence schemas | public rc.6 gate and smoke evidence is immutable; rc.8 adds bounded server command delivery and strict browser response validation, while target TrueNAS and HIL remain pending |
