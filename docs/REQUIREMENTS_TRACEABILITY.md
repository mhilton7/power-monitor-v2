...
| 17 | sessions/MFA/CSRF/throttling/roles/last-owner/home scope/server permissions, including authorized first-sensor home discovery with no enrolled devices and explicit multi-home selection | implemented and covered by backend isolation and frontend single/multi/zero-scope tests; external CI pending |
...
| 27 | server/frontend/deployment/firmware gates and evidence schemas | local server 101/4, PostgreSQL 102/3, frontend 16/19, firmware 55/36/63+63, and 120-day simulation passed; release smoke/HIL pending |
