...
| Caddy source/runtime | source `v2.11.4` at commit `e2eee6a7fce366321294c9c2a79f3146891dcbdf`, module sum `h1:XKxkMTgNSizEvKG6QHue6cAsFOteU2qA61w2tKkCWi0=`; runtime `2.11.4-alpine@sha256:5f5c8640aae01df9654968d946d8f1a56c497f1dd5c5cda4cf95ab7c14d58648` | project-owned standard-module-only TLS gateway; rebuilt with `x/net 0.56.0`, `x/text 0.39.0`, and `grpc 1.82.1`, then the unused privileged-port file capability is removed |
