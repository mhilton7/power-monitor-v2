...
| API SQLite runtime | `sqlite-libs` `3.53.4-r0` | exact security-fixed Alpine v3.23 package revision required after CVE-2026-11822 and CVE-2026-11824 were published; tagged CI fails closed if the pinned revision is unavailable or either finding remains |
