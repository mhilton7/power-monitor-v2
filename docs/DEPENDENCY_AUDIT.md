...
| Alpine OpenSSL runtime | `openssl`, `libcrypto3`, and `libssl3` `3.5.8-r0` | exact security-fixed package revision required by the API and frontend final images after CVE-2026-14456 was published; tagged CI fails closed if the pinned revision is unavailable or a HIGH/CRITICAL finding remains |
