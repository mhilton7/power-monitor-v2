...
> This UI-oriented document applies to v0.1.0-rc.4 and later releases that
...
A direct application-only rollback from v0.1.0-rc.4 at migration head
`20260815_0011` to v0.1.0-rc.3 at `20260813_0007` is unauthorized. Rc.4's
forward-migration gate, when published, cannot prove that rc.3 binaries can read
a database touched by rc.4; `not_exercised_github_hosted_smoke` is not rollback
evidence. The immutable server rc.2 tag has no GitHub Release and is not a
predecessor.

Historical rc.3 evidence proved only forward rc.1-to-rc.3 upgrade; it does not
authorize either rc.3-to-rc.1 or rc.4-to-rc.3 rollback.

Public rc.3 has a seven-service YAML and no `initialize` service. Its attached
instructions use the rc.3 host-preparation contract. The rc.4 Windows/SMB
initializer procedure cannot be combined with rc.3 assets and does not make an
rc.4-to-rc.3 rollback shell-free.
