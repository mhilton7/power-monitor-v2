...
> This UI-oriented source document is prepared for v0.1.0-rc.18. Public rc.16 and earlier releases
...
A direct application-only rollback from v0.1.0-rc.18 to an earlier public
...
cannot prove that older binaries correctly handle state touched by rc.18;
