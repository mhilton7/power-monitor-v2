...
> This UI-oriented source document is prepared for v0.1.0-rc.11. Public rc.10, rc.9, rc.8, rc.6, rc.5,
...
A direct application-only rollback from v0.1.0-rc.11 to public v0.1.0-rc.10 is
unauthorized without a separate recovery test. Rc.11 retains Alembic head
`20260816_0013`, and a forward-migration gate cannot prove that older
binaries correctly handle state touched by rc.11; `not_exercised_github_hosted_smoke`
...
authorize rc.3-to-rc.1, rc.5-to-rc.3, rc.6-to-rc.5, rc.8-to-rc.6, rc.9-to-rc.8, rc.10-to-rc.9, or rc.11-to-rc.10 rollback.

Public rc.3 has a seven-service YAML and no `initialize` service. Its attached
instructions use the rc.3 host-preparation contract. The rc.5/rc.6/rc.8/rc.9/rc.10/rc.11 Windows/SMB
