...
> This UI-only flow is prepared for the complete signed v0.1.0-rc.10 release
> asset set. Public rc.9, rc.8, rc.6, rc.5, and immutable rc.3 assets retain their attached
...
The coordinated rc.10 release retains public rc.9 Alembic head
...
above before applying rc.10. If either preflight stops, leave the prior datasets
...
dataset. Rc.5, rc.6, rc.8, rc.9, and rc.10 do not mount or write it, and the upgrade never deletes it.
