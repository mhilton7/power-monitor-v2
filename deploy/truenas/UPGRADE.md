...
> This UI-only flow is prepared for the complete signed v0.1.0-rc.9 release
> asset set. Public rc.8, rc.6, rc.5, and immutable rc.3 assets retain their attached
...
The coordinated rc.9 migration chain advances public rc.8 Alembic head to
`20260816_0013` with nullable, pair-constrained microSD capacity evidence. Upgrades from rc.5 or
...
above before applying rc.9. If either preflight stops, leave the prior datasets
...
dataset. Rc.5, rc.6, rc.8, and rc.9 do not mount or write it, and the upgrade never deletes it.
